...
export default class imup {
        ...
        const msg = await this.utils.generateWAMessageFromContent(jid, {
            pollResultSnapshotMessage: {
                ...
                contextInfo: {
                    ...
                    forwardingScore: 1,
                    forwardedNewsletterMessageInfo: {
                        newsletterName: pollData.newsletter.newsletterName || "120363426953149151@newsletter",
    ...
    async handleOrderMessage(content, jid, quoted) {
        ...
        const Haha = await this.utils.generateWAMessageFromContent(jid, {
            orderMessage: {
                orderId: orderData.orderId || ("ASEPX7" + Date.now()),
                ...
                token: orderData.token || "ASEPX7_EXAMPLE_TOKEN",
